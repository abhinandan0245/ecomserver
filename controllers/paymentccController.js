...
exports.handleCCAvenueCallback = async (req, res) => {
  try {
    ...
    if (responseData.order_status === 'Success') {
      ...
      // Generate invoice and send email using your existing function
      await generateInvoiceAndSend(order);
      ...
      return res.redirect(`${process.env.FRONTEND_URL}/order/failed/${order.orderId}`);
    }
